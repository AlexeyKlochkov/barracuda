...
<div class ="container">
    <div class="jumbotron">
        <div class="text-center"><h4>Add Parnter</h4></div>
        <div id="partner_error_message"></div>
        <form id="addUser" method="post" class="form-horizontal" action="add_partner/submit/">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="text" class="form-control" name="company"
                       required
                       data-fv-notempty-message="Company is required" />
            </div>
        </div>
        <div class="form-group">
